...
### Node 0.10 / for...of
* [loose mode style plugin](https://github.com/webconnex/babel-plugin-for-of-array-only/issues/1)
* [forof in extendr breaks node 0.10 support, breaking taskgroup, breaking safeps, breaking lazy-require](https://github.com/bevry/lazy-require/issues/6)
* [forof in typechecker breaks node 0.10 support, breaking extract-opts, breaking cson](https://github.com/bevry/cson/issues/68), [breaking meteor](https://github.com/bevry/base/issues/20)
...
### Node 0.10 / meteor
* [meteor uses node 0.10 and cson](https://github.com/bevry/cson/pull/69#issuecomment-171873371)
* [meteor finally upgraded from node 0.10 to node 4 only on 25th July 2016](https://github.com/meteor/meteor/issues/5124)
...
* [react-element-to-jsx-string: sortobject update (1.1.0) breaks webpack](https://github.com/algolia/react-element-to-jsx-string/issues/25)
